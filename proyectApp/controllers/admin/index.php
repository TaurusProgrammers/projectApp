	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<center><h1>Digitación PoliticApp </h1></center>
						</div><!-- /.page-header -->

						<div class="row">
							<div class="col-xs-12">
								<center><img src="../../assets/images/admin.png"></center>
							</div><!-- /.col -->
							<div style="margin-top: 20%;width: 100%;">
								<center><button class="btn btn-primary" onclick="mostrar();" name="registrar" style="margin-right: 20%;font-size: 16px;">
                                        <i class="ace-icon fa fa-search bigger-210"></i>
                                        CONSULTAS
                                    </button><a href="register.php"><button class="btn btn-danger" name="registrar" style="font-size: 16px;">
                                        <i class="ace-icon fa fa-plus bigger-210"></i>
                                        REGISTRO VOTANTES
                                    </button></a></center>
							</div>
						</div><!-- /.row -->
			...
			<?php if(isset($_GET['dup'])){
									$message=$_GET['dup'];
									echo "<script languaje='javascript' type='text/javascript'>alert('Intento realizar duplicado de usuario pertenece al Lider: ".$message."');</script>";
								}
								if(isset($_GET['error'])){
									echo "<script languaje='javascript' type='text/javascript'>alert('No se pudo realizar la operacion se perdio conexion con el servidor');</script>";
								}
								if(isset($_GET['cand'])){
									echo "<script languaje='javascript' type='text/javascript'>alert('Se realizo registro con exito!');</script>";
								}
			?>
			<?php 
		...
		<script type="text/javascript">
			function mostrar() {
			 	$("#sModal").modal();
			 	document.getElementById('votante').value='';
			 }
		</script>
		<!-- <![endif]-->
