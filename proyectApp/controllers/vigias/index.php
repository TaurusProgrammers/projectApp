				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<center><h1>Reporte de votos</h1></center>
						</div><!-- /.page-header -->

						<div class="row">
							<div class="col-xs-12">
								<form action="register/info.php" method="POST">
									<input type="hidden" name="cedula" value="<?php echo $_SESSION['iduser'];?>">
										<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													<th class="detail-col">Martha Villalba</th>
													<th>Jose Name</th>
													<th>Eduardo Crissien</th>
											...
											<tbody>
												<tr>
													<td><input type="text" name="martha"></td>
													<td><input type="text" name="jose"></td>
													<td><input type="text" name="eduardo"></td>
													<td><input type="text" name="blanco"></td>
												</tr>
											</tbody>
										</table>
										<button class="btn btn-primary" name="registrar">
