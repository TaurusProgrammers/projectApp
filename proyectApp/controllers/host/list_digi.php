				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<center><h1>Digitadores</h1></center>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
										...
										?>
											...
											<thead>
												<tr>
													<th class="detail-col">Digitador</th>
													<th>Cedula</th>
													<th>usuario</th>
													<th>contraseña</th>
												</tr>
											...
											<tbody>
												<?php
													$año=date ("Y");
													$sqlc=mysqli_query($con, "SELECT * FROM usuarios WHERE cedula='".$_POST['cedula']."' and id_rol='2'");
										...
										<?php }else{
											...
											<tbody>
												<?php
													$año=date ("Y");
													$sqlc=mysqli_query($con, "SELECT * FROM usuarios WHERE id_rol='2'");
													while ($res=mysqli_fetch_assoc($sqlc)) {
														$name=$res['nombres'];
														$last=$res['apellidos'];
														$cedula=$res['cedula'];
