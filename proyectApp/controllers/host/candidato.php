				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<center><h1>Registros Candidatos</h1></center>
						</div><!-- /.page-header -->

						<div class="row">
							<div class="col-xs-12">
								<form action="registros/candidato.php" method="POST">
									...
									<br><br>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Cargo Politico:</label>

										<div class="col-sm-9">
											<span class="input-icon input-icon-right" style="width: 30%;">
												<select style="width: 100%;" name="cargo">
													<option> </option>
													<?php 
														$sql=mysqli_query($con, "SELECT * FROM cargos_politicos");
